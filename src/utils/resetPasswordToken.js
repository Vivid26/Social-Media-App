    ...
    html: `
        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    <p>Hello, ${user.name}</p>
                    <p>Enter this OTP to complete reset : ${otp} </p>
                    <p>Use this OTP as a parameter in the reset password route. If you didn't request password reset, kindly please ignore this email.</p>
                </div>
            </div>
        </body>
        </html>
